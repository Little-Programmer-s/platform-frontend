...
function Hero() {
  return (
    <section className="w-[100vw] !h-[100vh] overflow-hidden grid-pattern relative">
        ...
        <div className="container mx-auto max-w-7xl h-[100vh] flex flex-col justify-center items-center">
          <div className='flex flex-col justify-center items-center'>
            ...
            <p className='mt-8 text-2xl font-extralight'>Hi! I’m John Doe, a Next.js Developer based in Russia</p>

            <button className='bg-gradient-to-r to-midnight from-slate-900 px-8 py-4 mt-8 border rounded-2xl border-slate-900 cursor-pointer'>
              See my work
            </button>
          </div>
        </div>
